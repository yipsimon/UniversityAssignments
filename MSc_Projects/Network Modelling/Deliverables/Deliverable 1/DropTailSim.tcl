...
$ns duplex-link $r1 $r2 75Mb 3.1ms DropTail
...
#$ns duplex-link-op $n(1) $r1 orient 290deg
#$ns duplex-link-op $n(2) $r1 orient 350deg
#$ns duplex-link-op $n(3) $r1 orient 50deg
#$ns duplex-link-op $n(4) $r1 orient 110deg

#$ns duplex-link-op $n(5) $r2 orient 290deg
#$ns duplex-link-op $n(6) $r2 orient 230deg
#$ns duplex-link-op $n(7) $r2 orient 170deg
#$ns duplex-link-op $n(8) $r2 orient 110deg
